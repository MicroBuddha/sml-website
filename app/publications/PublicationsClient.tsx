...
export default function PublicationsClient({ publications }: { publications: Publication[] }) {
  ...
  // group by year, then split into Recent (>= RECENT_FROM) and Earlier
  ...
  const recentYears = years.filter(y => y >= RECENT_FROM)
  const earlierYears = years.filter(y => y < RECENT_FROM)
          ...
          <div className="pub-entry__top">
            ...
            <div className="pub-entry__main">
              ...
              <div className="pub-entry__links">
                ...
                <a href={SCHOLAR_PROFILE_URL} target="_blank" rel="noreferrer" className="pub-entry__link">Scholar</a>
                {typeof pub.citations === 'number' && pub.citations > 0 && (
                  <span className="pub-entry__citations">
  ...
  return (
    <>
      <style>{`
        ...
        /* ── ERA SECTION ── */
        .pub-era { margin-bottom: 72px; }
        .pub-era:last-child { margin-bottom: 0; }
        .pub-era__header {
          display: flex;
          ...
          margin-bottom: 32px;
          padding-bottom: 12px;
          border-bottom: 2px solid #3c3489;
        }
        .pub-era__title {
        ...
        .pub-entry__badge--conference  { background: #eef1f6; color: #3c3489; }
        ...
        .pub-entry__link:hover { border-color: #3c3489; color: #26215c; }
          ...
          {publications.length === 0 ? (
            ...
            <>
              {recentYears.length > 0 && (
                <section className="pub-era">
                  <div className="pub-era__header">
                    <h2 className="pub-era__title">Recent Publications</h2>
                    <span className="pub-era__note">{RECENT_FROM} onwards</span>
                  </div>
              ...
              {earlierYears.length > 0 && (
                <section className="pub-era">
                  <div className="pub-era__header">
                    <h2 className="pub-era__title">Earlier Publications</h2>
                    <span className="pub-era__note">before {RECENT_FROM}</span>
                  </div>
                  {earlierYears.map(renderYear)}
                </section>
              )}
            </>
          )}
