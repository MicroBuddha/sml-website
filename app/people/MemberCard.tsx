...
export default function MemberCard({ name, role, bio, email, googleScholar, linkedin, photoUrl }: MemberCardProps) {
      ...
      <div className="member-card">
        ...
        {(email || googleScholar || linkedin) && (
          <div className="member-links">
            ...
            {googleScholar && (
              <a href={googleScholar} target="_blank" rel="noreferrer" className="member-email">
                Scholar ↗
              </a>
            )}
            {linkedin && (
              <a href={linkedin} target="_blank" rel="noreferrer" className="member-email">
                LinkedIn ↗
              </a>
            )}
          </div>
