...
export default function PeoplePage() {
  ...
  // Seniority-wise ordering within each role group: lower seniorityOrder first,
  // people without one are sorted alphabetically after those with one.
  const bySeniority = (a: any, b: any) => {
    const aHas = typeof a.seniorityOrder === 'number'
    const bHas = typeof b.seniorityOrder === 'number'
    if (aHas && bHas) return a.seniorityOrder - b.seniorityOrder
    if (aHas) return -1
    if (bHas) return 1
    ...
    <>
      <style>{`
        ...
        .member-bio-toggle {
          ...
          text-decoration-color: #cecbf6;
          transition: text-decoration-color 0.2s, color 0.2s;
        }
        .member-bio-toggle:hover {
          color: #26215c;
          text-decoration-color: #26215c;
        }
        ...
        .member-card:hover .member-links {
          opacity: 1;
                      ...
                      <div key={p._id} className="pi-card">
                        ...
                        <div>
                          ...
                          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '14px', alignItems: 'center' }}>
                            ...
                            {p.linkedin && (
                              <a href={p.linkedin} target="_blank" rel="noreferrer" className="pi-info__email">
                                LinkedIn ↗
                              </a>
                            )}
                            {p.googleScholar && (
                              <a href={p.googleScholar} target="_blank" rel="noreferrer" className="pi-info__email">
                                Google Scholar ↗
                              </a>
                            )}
                          </div>
