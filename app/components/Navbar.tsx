...
// Nav order: Foundation now sits immediately before Contact, and a new
// Course link has been added. To change the menu, just edit this array.
const links = [
  { href: '/', label: 'Home' },
  { href: '/people', label: 'People' },
  { href: '/research', label: 'Research' },
  { href: '/workshops-events', label: 'Workshops' },
